...
public class MainActivity extends FragmentActivity implements OnMapReadyCallback {
   ...
   //defining variable which keeps lat long info.
    LatLng latLng;
    LatLng latLng1;
    LatLng latLng2;
    LatLng latLng3;
    ...
    float[] minimumLocation = new float[30];


    int[] personByAtm = new int[30];
    int[] totalTime = new int[30];
    int[] indexArray = new int[30];
    ...
    //assigning ATM locations on MAP.
    public void assign(){
        //assigning ATM location information
